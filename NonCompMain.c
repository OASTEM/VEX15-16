...
#pragma config(Motor,  port4,           lTopShooter,   tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_2, 1000)
#pragma config(Motor,  port5,           rBottomShooter, tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_3, 1000)
...
#pragma config(Motor,  port8,           rDrive,        tmotorVex393, openLoop)
