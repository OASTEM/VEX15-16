...
#pragma config(Motor,  port2,           lDrive,        tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port10,           rTopShooter,   tmotorVex393, openLoop, encoder, encoderPort, I2C_4, 1000)
#pragma config(Motor,  port4,           rBottomShooter, tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_3, 1000)
#pragma config(Motor,  port6,           rDrive,        tmotorVex393, openLoop)
#pragma config(Motor,  port7,           intake,        tmotorVex393, openLoop)
#pragma config(Motor,  port1,           lTopShooter,   tmotorVex393, openLoop, reversed, encoder, encoderPort, I2C_1, 1000)
#pragma config(Motor,  port9,           lBottomShooter, tmotorVex393, openLoop, encoder, encoderPort, I2C_2, 1000)
